    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            <div class="flex gap-3">
                <a href="{{ route('anggota.keamanan') }}" class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-emerald-600 transition-colors flex items-center gap-2 group bg-white/50 px-4 py-2 rounded-xl">
            ...
            <div class="p-8 md:p-12">
                ...
                <form action="{{ route('anggota.profil.update') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <div class="flex justify-between items-center pt-4">
                        <a href="{{ route('anggota.dashboard') }}" class="text-[10px] font-black uppercase text-slate-400 hover:text-rose-600 transition-colors">
                            ← Batal
                        </a>
