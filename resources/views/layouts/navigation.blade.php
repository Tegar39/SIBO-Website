            ...
            <div class="hidden sm:flex flex-7 justify-center">
                <div class="flex items-center gap-5">
                    ...
                    @guest
                        ...
                        <a href="{{ route('home') }}#pac" wire:navigate data-section="pac" class="nav-item">PAC</a>
    ...
    <div x-show="open" 
        ...
        <div class="px-4 py-6 space-y-3">
            @guest
                ...
                <a href="{{ route('home') }}#pac" wire:navigate class="nav-item-mobile" @click="open = false">PAC</a>
