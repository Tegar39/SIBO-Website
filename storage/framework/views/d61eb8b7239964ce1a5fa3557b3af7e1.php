    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="border-t pt-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="<?php echo e(route('admin.laporan.kegiatan.export.csv')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-2 transition">CSV</a>
        ...
        <div class="mt-8 bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="px-6 py-5 bg-gradient-to-r from-indigo-700 to-slate-800">
                ...
                <p class="text-indigo-100 text-xs">Hadir: <?php echo e($totalHadir ?? 0); ?> · Tidak Hadir: <?php echo e($totalTidakHadir ?? 0); ?></p>
            </div>
            <div class="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <a href="<?php echo e(route('admin.laporan.absensi')); ?>" class="text-center bg-slate-800 hover:bg-emerald-600 text-white px-5 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all">Lihat Detail Absensi</a>
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('admin.laporan.absensi.export.excel')); ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-xs font-bold">Excel</a>
                    <a href="<?php echo e(route('admin.laporan.absensi.export.csv')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-xs font-bold">CSV</a>
                    <a href="<?php echo e(route('admin.laporan.absensi.export.pdf')); ?>" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-xs font-bold">PDF</a>
                </div>
            </div>
        </div>
