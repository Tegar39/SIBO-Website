...
<div class="pt-40 pb-12 bg-gradient-to-br from-slate-50 via-emerald-50/40 to-white min-h-screen">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white/95 backdrop-blur rounded-[2rem] shadow-2xl shadow-slate-200/70 overflow-hidden border border-emerald-100">
            <div class="bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-500 px-6 py-6">
                <h2 class="text-xl font-bold text-white">Tambah Peserta untuk <?php echo e($kegiatan->judul); ?></h2>
                <p class="text-emerald-100 text-xs mt-1">*Peserta tidak perlu memiliki akun</p>
            </div>
            <div class="p-6">
                <form action="<?php echo e(route('admin.pendaftaran.store', $kegiatan->id_kegiatan)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="<?php echo e(route('admin.pendaftaran.show', $kegiatan->id_kegiatan)); ?>" class="bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold py-3 px-8 rounded-2xl transition">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Sibo\resources\views/admin/pendaftaran/create.blade.php ENDPATH**/ ?>