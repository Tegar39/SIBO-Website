            ...
            <div class="p-6">
                <form action="<?php echo e(route('admin.pendaftaran.store', $kegiatan->id_kegiatan)); ?>" method="POST">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="<?php echo e(route('admin.pendaftaran.show', $kegiatan->id_kegiatan)); ?>" class="bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold py-3 px-6 rounded-xl transition">Batal</a>
                    </div>
                </form>
            </div>
        </div>
