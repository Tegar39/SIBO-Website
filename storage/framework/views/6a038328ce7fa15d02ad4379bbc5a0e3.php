...
<div class="bg-slate-50 min-h-screen py-16 md:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 flex flex-wrap justify-center gap-4">
            <a href="<?php echo e(route('galeri.publik.index')); ?>" 
               class="px-6 py-2 rounded-full text-sm font-bold transition-all <?php echo e(!request('kegiatan') ? 'bg-green-600 text-white shadow-md' : 'bg-white text-slate-600 hover:bg-green-50 border border-slate-200'); ?>">
                Semua Kegiatan
            </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kegiatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(route('galeri.publik.index', ['kegiatan' => $keg->id_kegiatan])); ?>" 
                   class="px-6 py-2 rounded-full text-sm font-bold transition-all <?php echo e(request('kegiatan') == $keg->id_kegiatan ? 'bg-green-600 text-white shadow-md' : 'bg-white text-slate-600 hover:bg-green-50 border border-slate-200'); ?>">
                    <?php echo e($keg->judul); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galeri->count() > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="group relative overflow-hidden rounded-2xl bg-white shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer"
                         onclick="openLightbox('<?php echo e(Storage::url($foto->path_file)); ?>', '<?php echo e(addslashes($foto->judul_foto ?? $foto->kegiatan->judul)); ?>')">
                        <div class="aspect-square overflow-hidden bg-slate-100">
                            <img src="<?php echo e(Storage::url($foto->path_file)); ?>" 
                                 alt="<?php echo e($foto->judul_foto ?? 'Galeri'); ?>"
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                            <h3 class="text-white font-bold text-sm md:text-base line-clamp-1"><?php echo e($foto->judul_foto ?? $foto->kegiatan->judul); ?></h3>
                            <p class="text-green-300 text-xs mt-1">
                                <?php echo e(\Carbon\Carbon::parse($foto->kegiatan->tanggal)->translatedFormat('d M Y')); ?>
            ...
            <div class="mt-12">
                <?php echo e($galeri->appends(request()->query())->links()); ?>
