    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="<?php echo e(route('admin.kegiatan.index')); ?>" method="GET" class="flex flex-col md:flex-row gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search') || request('kategori')): ?>
                        <a href="<?php echo e(route('admin.kegiatan.index')); ?>" class="bg-red-500 text-white border-2 border-gray-900 px-6 py-3 font-black uppercase italic text-[10px] flex items-center justify-center hover:bg-red-600 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]">
                            RESET
                        </a>
                        ...
                        <div class="p-6 flex-1">
                            <div class="flex items-center gap-2 mb-3">
                                <span class="px-2 py-0.5 text-[8px] font-black rounded border border-gray-900 uppercase
                                    <?php if($k->status == 'aktif'): ?> bg-green-400 text-gray-900
                                    <?php elseif($k->status == 'selesai'): ?> bg-gray-200 text-gray-600
                                    <?php else: ?> bg-red-400 text-white <?php endif; ?>">
                                    <?php echo e($k->status); ?>

                                </span>
                                <span class="text-[10px] font-bold text-gray-400"><?php echo e(\Carbon\Carbon::parse($k->tanggal)->format('d M Y')); ?></span>
                            </div>
                            ...
                            <div class="space-y-2 mb-6 text-gray-500">
                                <div class="flex items-center gap-2 text-[11px] font-bold">
                                    ...
                                    <span class="truncate"><?php echo e($k->lokasi ?: 'Internal'); ?></span>
                                </div>
                                <div class="flex items-center gap-2 text-[11px] font-bold">
                                    ...
                                    <span>Kuota: <?php echo e($k->kuota ?: 'Tak Terbatas'); ?></span>
                                </div>
                            </div>
                        </div>

                        <div class="grid grid-cols-2 border-t-2 border-gray-900 bg-gray-50">
                            <a href="<?php echo e(route('admin.kegiatan.edit', $k->id_kegiatan)); ?>" class="p-4 text-center text-[10px] font-black uppercase tracking-widest hover:bg-yellow-400 transition-colors border-r-2 border-gray-900">
                                EDIT DATA
                            </a>
                            <form action="<?php echo e(route('admin.kegiatan.destroy', $k->id_kegiatan)); ?>" method="POST" onsubmit="return confirm('Hapus kegiatan ini?')" class="flex">
        ...
        <?php else: ?>
            <div class="border-4 border-dashed border-gray-200 py-24 text-center">
                ...
                <a href="<?php echo e(route('admin.kegiatan.index')); ?>" class="text-green-700 underline font-black text-xs uppercase tracking-widest">Tampilkan Semua</a>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
