...
<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 border-b-4 border-gray-900 pb-6 gap-4">
            ...
            <a href="<?php echo e(route('admin.kegiatan.create')); ?>" class="bg-yellow-400 border-2 border-gray-900 text-gray-900 px-6 py-3 text-[11px] font-black uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2">
                        ...
                        <div class="p-6 flex-1">
                            ...
                            <div class="space-y-2 mb-6">
                                ...
                                <div class="flex items-center gap-2 text-xs font-bold text-gray-500">
                                    ...
                                    <span>Kuota: <?php echo e($k->kuota ?: '∞'); ?></span>
                                </div>
                            </div>
                        </div>
