...
<head>
    <meta charset="utf-8">
    <title>Sertifikat <?php echo e($certificate_number ?? '-'); ?></title>
    <style>
...
<div class="page">
    ...
    <div class="logo-wrap">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoData): ?>
            <img class="logo" src="<?php echo e($logoData); ?>" alt="Logo SIBO">
        <?php else: ?>
            <strong>SIBO</strong>
    ...
    <div class="content">
        ...
        <div class="certificate-number">NO : <?php echo e($certificate_number ?? '-'); ?></div>

        <div class="given">Diberikan kepada :</div>
        <div class="recipient"><?php echo e($nama_peserta ?? 'Nama Peserta'); ?></div>

        <div class="role-line">sebagai <strong>Peserta</strong></div>

        <div class="activity-text">
            Atas partisipasinya dalam kegiatan
            <span class="activity-title"><?php echo e($kegiatan->judul ?? 'Nama Kegiatan'); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deskripsi !== ''): ?>
                <span class="activity-desc"><?php echo e($deskripsi); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>

        <div class="date-line">Tanggal kegiatan : <strong><?php echo e($tanggalKegiatan); ?></strong></div>
    </div>
    ...
    <div class="issued">
        Kediri, <?php echo e($tanggalTerbit); ?> &nbsp; | &nbsp; Diterbitkan oleh Sistem SIBO
    </div>
