        ...
        <div class="bg-white/70 backdrop-blur-md rounded-[2.5rem] border border-white/50 shadow-xl overflow-hidden">
            <div class="p-8 md:p-12">
                ...
                <div class="mb-8 bg-emerald-50 border border-emerald-100 rounded-[2rem] p-6">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 leading-relaxed">
                                ...
                                Kode dikirim ke email akun dan berlaku <?php echo e(config('auth.login_otp_expires_minutes', 10)); ?> menit.
                            </p>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($otpVerified): ?>
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('anggota.keamanan.otp.request')); ?>" method="POST" class="shrink-0">
                                <?php echo csrf_field(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$otpVerified && $otpPending): ?>
                        <div class="mt-6 bg-white border border-emerald-100 rounded-2xl p-4">
                            <form action="<?php echo e(route('anggota.keamanan.otp.verify')); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-3 items-end">
                                <?php echo csrf_field(); ?>
                                <div>
                            ...
                            <form action="<?php echo e(route('anggota.keamanan.otp.resend')); ?>" method="POST" class="mt-3">
                                <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('anggota.keamanan.update-password')); ?>" method="POST">
                    ...
                    <div class="bg-slate-900 rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden">
                        ...
                        <div class="space-y-6 relative z-10">
                            <div>
                                ...
                                <input type="password" name="current_password" 
                                       ...
                                       placeholder="Masukkan password lama Anda" required <?php echo e($otpVerified ? '' : 'disabled'); ?>>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="password" name="new_password" id="new_password"
                                           class="w-full bg-white/10 border border-white/10 rounded-2xl px-5 py-3.5 text-sm text-white focus:ring-2 focus:ring-amber-400 focus:bg-white/20 outline-none transition-all" 
                                           placeholder="Minimal 8 karakter, huruf besar/kecil, angka, simbol" required <?php echo e($otpVerified ? '' : 'disabled'); ?>>
                                </div>
                                <div>
                                    ...
                                    <input type="password" name="new_password_confirmation" id="password_confirmation"
                                           class="w-full bg-white/10 border border-white/10 rounded-2xl px-5 py-3.5 text-sm text-white focus:ring-2 focus:ring-amber-400 focus:bg-white/20 outline-none transition-all" 
                                           placeholder="Ulangi password baru" required <?php echo e($otpVerified ? '' : 'disabled'); ?>>
                        ...
                        <div class="flex justify-between items-center mt-10 pt-4 relative z-10">
                            ...
                            <button type="submit" id="submitBtn" <?php echo e($otpVerified ? '' : 'disabled'); ?> class="group relative bg-amber-500 hover:bg-white text-slate-900 font-black px-10 py-4 rounded-2xl text-[10px] uppercase tracking-[0.2em] transition-all flex items-center gap-3 <?php echo e($otpVerified ? '' : 'opacity-50 cursor-not-allowed'); ?>">
