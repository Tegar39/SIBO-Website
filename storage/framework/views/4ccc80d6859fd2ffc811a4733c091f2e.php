                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role == 'anggota'): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftaran): ?>
                                        <div class="p-6 rounded-[2rem] border text-center shadow-inner
                                            <?php if($pendaftaran->status == 'disetujui'): ?> bg-emerald-50 border-emerald-100 text-emerald-600 
                                            <?php elseif($pendaftaran->status == 'ditolak'): ?> bg-rose-50 border-rose-100 text-rose-600 
                                            ...
                                            <p class="text-lg font-black uppercase tracking-tighter"><?php echo e($pendaftaran->status); ?></p>
                                            <p class="text-[9px] font-bold opacity-70 mt-2 leading-tight">
                                                <?php echo e($pendaftaran->status == 'pending' ? 'Mohon tunggu konfirmasi administrator.' : 'Silakan cek email atau dashboard riwayat.'); ?>
                                    ...
                                    <?php elseif($kegiatan->status != 'aktif'): ?>
                                        <div class="w-full bg-slate-100 text-slate-400 text-center py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest border border-slate-200">
                                            Pendaftaran <?php echo e(strtoupper($kegiatan->status)); ?>
