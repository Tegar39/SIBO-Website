...
<div class="pt-28 pb-12 bg-slate-50 min-h-screen font-sans">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('admin.galeri.show', $kegiatan->id_kegiatan)); ?>" class="inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-rose-500 transition-colors group">
            ...
            <div class="p-8 md:p-10 border-b border-white flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/30 text-center md:text-left">
                <div>
                    ...
                    <div class="flex items-center justify-center md:justify-start gap-2 mt-3 text-slate-400">
                        ...
                        <span class="text-xs font-bold uppercase tracking-widest"><?php echo e($kegiatan->judul); ?></span>
                    </div>
                </div>
