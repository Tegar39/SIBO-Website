    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white border-4 border-gray-900 shadow-[15px_15px_0px_0px_rgba(21,128,61,1)] overflow-hidden">
            <div class="bg-green-700 px-8 py-6 border-b-4 border-gray-900">
                ...
                <p class="text-[10px] text-green-100 font-bold uppercase tracking-widest italic mt-1">Kegiatan: <?php echo e($kegiatan->judul); ?></p>
            </div>
            ...
            <div class="p-8">
                <form action="<?php echo e(route('admin.galeri.store', $kegiatan->id_kegiatan)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-between items-center mt-12 pt-8 border-t-4 border-gray-100">
                        <a href="<?php echo e(route('admin.galeri.show', $kegiatan->id_kegiatan)); ?>" class="text-[10px] font-black uppercase text-gray-400 hover:text-red-600 tracking-widest">
                            ← Batal
                        </a>
