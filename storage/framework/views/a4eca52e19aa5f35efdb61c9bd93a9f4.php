    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white/70 backdrop-blur-md border border-white/50 rounded-[2.5rem] shadow-xl overflow-hidden">
            ...
            <div class="bg-emerald-600 px-8 py-10 flex justify-between items-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-[10px] text-emerald-100 font-bold uppercase tracking-[0.3em] mt-1 opacity-80 font-mono">
                        NO: <?php echo e($anggota->nomor_anggota); ?>
            ...
            <div class="p-8 md:p-12">
                ...
                <form action="<?php echo e(route('admin.anggota.update', $anggota->id_anggota)); ?>" method="POST" enctype="multipart/form-data" id="editForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $anggota->nama_lengkap)); ?>" class="w-full bg-slate-100/50 border-none rounded-2xl p-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500 transition-all uppercase" required>
                        </div>

                        <div class="space-y-2">
                            <label class="block text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Nomor Kontak</label>
                            <input type="text" name="kontak" value="<?php echo e(old('kontak', $anggota->kontak)); ?>" class="w-full bg-slate-100/50 border-none rounded-2xl p-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500 transition-all" required>
                        </div>

                        <div class="space-y-2">
                            <label class="block text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Tempat Lahir</label>
                            <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $anggota->tempat_lahir)); ?>" class="w-full bg-slate-100/50 border-none rounded-2xl p-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500 transition-all uppercase">
                        </div>
                        ...
                        <div class="space-y-2" id="tanggalLahirGroup">
                            ...
                            <input type="date" name="tgl_lahir" id="tgl_lahir" value="<?php echo e(old('tgl_lahir', $anggota->tgl_lahir)); ?>" class="w-full bg-slate-100/50 border-none rounded-2xl p-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500 transition-all">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="alamat" rows="2" class="w-full bg-slate-100/50 border-none rounded-2xl p-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500 transition-all leading-relaxed"><?php echo e(old('alamat', $anggota->alamat)); ?></textarea>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="pac" class="w-full bg-slate-100/50 border-none rounded-2xl p-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500 transition-all" required>
                                <?php
                                    $pacList = ['BADAS','PARE','KANDANGAN','PURWOASRI','PAPAR','KUNJANG','PLEMAHAN','GAMPENGREJO','NGASEM','GURAH','PAGU','PLOSOKLATEN','WATES','KANDAT','KRAS','RINGINREJO','NGADILUWIH','SEMEN','MOJO','BANYAKAN','GROGOL','TAROKAN','KAYENKIDUL','NGANCAR','PUNCU','KEPUNG'];
                                ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pacList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($pac); ?>" <?php echo e($anggota->pac == $pac ? 'selected' : ''); ?>><?php echo e($pac); ?></option>
                            ...
                            <div class="flex flex-col md:flex-row items-center gap-10">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($anggota->foto_profil): ?>
                                    <div class="flex flex-col items-center gap-2">
                                        <div class="relative">
                                            <img src="<?php echo e(Storage::url($anggota->foto_profil)); ?>" class="w-24 h-24 object-cover rounded-2xl border-4 border-white shadow-lg ring-1 ring-emerald-100">
