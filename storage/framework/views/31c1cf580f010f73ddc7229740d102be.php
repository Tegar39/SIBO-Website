        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('admin.anggota.create')); ?>" class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-5 rounded-lg shadow-md transition duration-200 flex items-center gap-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col group">
                                ...
                                <div class="relative bg-gradient-to-r from-green-700 to-green-800 px-4 py-4 flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-lg font-bold text-white line-clamp-1"><?php echo e($a->nama_lengkap); ?></h3>
                                        <p class="text-yellow-200 text-sm">No. Anggota: <?php echo e($a->nomor_anggota); ?></p>
                                    </div>
                                    <!-- Badge PAC -->
                                ...
                                <div class="p-4 flex-1 space-y-2 text-sm">
                                    ...
                                    <div class="flex items-center gap-2 text-gray-600">
                                        ...
                                        <span class="line-clamp-1"><?php echo e($a->tempat_lahir ? $a->tempat_lahir . ', ' . \Carbon\Carbon::parse($a->tgl_lahir)->format('d/m/Y') : '-'); ?></span>
                                    </div>
                                </div>

                                <!-- Tombol Aksi -->
                                <div class="border-t border-gray-100 p-3 flex justify-between items-center bg-gray-50">
                                    <a href="<?php echo e(route('admin.anggota.edit', $a->id_anggota)); ?>" class="text-indigo-600 hover:text-indigo-800 font-medium text-sm flex items-center gap-1">
                ...
                <?php else: ?>
                    <div class="text-center py-12 bg-gray-50 rounded-lg">
                        ...
                        <a href="<?php echo e(route('admin.anggota.create')); ?>" class="mt-4 inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Tambah Anggota</a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
