                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-white/60">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <div class="text-sm font-bold text-slate-800 group-hover:text-emerald-600 transition-colors uppercase"><?php echo e($p->anggota->nama_lengkap); ?></div>
                                <div class="text-[11px] font-medium text-slate-400"><?php echo e($p->anggota->nomor_anggota); ?></div>
                            </td>
                            <td class="px-6 py-5">
                                <span class="text-xs font-bold text-slate-600 uppercase"><?php echo e($p->anggota->pac ?? '-'); ?></span>
                            </td>
