                                        ...
                                        <tr class="hover:bg-emerald-50/40 transition-all group/row">
                                            ...
                                            <td class="px-8 py-6">
                                                ...
                                                <div class="text-[10px] font-bold text-slate-400 mt-1 flex items-center gap-1.5">
                                                    ...
                                                    ID: <?php echo e($p->anggota->nomor_anggota ?? 'Peserta Umum'); ?>
                                            ...
                                            <td class="px-8 py-6">
                                                <input type="text" name="keterangan[<?php echo e($p->id_daftar); ?>]" value="<?php echo e(old('keterangan.' . $p->id_daftar, $p->absensi->keterangan ?? '')); ?>" placeholder="Izin/sakit/alfa/catatan" class="w-full rounded-xl border-slate-200 text-xs focus:border-emerald-500 focus:ring-emerald-500">
                                            </td>
                                        </tr>
